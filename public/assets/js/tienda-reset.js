// Restablecer contraseña del cliente con el token del correo.
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        await api.post('/api/tienda/restablecer', { token, password: p1 });
        form.classList.add('oculto');
        ok.innerHTML = '¡Contraseña actualizada! Ya iniciaste sesión. Te llevamos a la tienda…';
